...
public class E05TwoDimArray02
{
	public static void main(String[] args)
	{
		...
		/*
		 * 초기화된 데이터를 출력한다. 배열명.length => 배열의 행 크기를 반환한다. 배열명[인덱스].length =>배열의 열 크기를
		 * 반환한다.
		 */
		...
		/*
		 * 시나리오] 다음 절차에 따라 프로그램을 작성하시오. 1. 2차원 배열을 선언한다. 세로(행)2, 가로(열)4 2. 난수를 이용하여 배열을
		 * 초기화한다. (0~100사이) 3. 배열전체요소를 매개변수로 전달된 정수만큼 증가시킨다. 4. 증가되기 전, 후 배열을 출력한다. 5.
		...
		/*
		 * 초기화 전, 후 두번의 출력을 해야 하므로 코드의 중복을 제거하기 위해 출력용 메서드를 정의한 후 필요할 때 호출하여 사용한다.
		 */
		showArray(twoArray);
		/*
	...
	/*
	 * 매개변수로 전달된 정수만큼 해당 2차원배열 전체 원소를 증가시킨다. 이를 위해 복합대입연산자를 사용하고 있다.
	 */

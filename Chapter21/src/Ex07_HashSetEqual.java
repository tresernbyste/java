...
/*
	HashSet<E> : Set계열의 컬렉션
		...
		- 객체가 순서없이 저장된다. 
		- 객체의 중복저장을 허용하지 않는다. 
		- 단 기본클래스(String, Integer등)가 아닌 개발자가 새롭게 정의한 
		클래스라면 hashCode(), equals() 메서드를 적절히 오버라이딩하여 
		중복에 대한 기준을 설정해야한다. 
...
class Student
{
	...
	@Override
	public String toString()  // 오버라이딩 하지 않으면 hachcode 값이 나옴
	{
		return name + ":" + age;
	}
...
//	}
	...
	public boolean equals(Object obj)	
	{
		...
		// name, age 둘다 비교 후 먼저 입력한 값이 나옴 하나라도 다르면 
		// 비교 안 함
